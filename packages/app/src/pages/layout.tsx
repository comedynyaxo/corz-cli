...
import { base64Encode } from "@corz-ai/core/util/encode"
import { decode64 } from "@/utils/base64"
import { ResizeHandle } from "@corz-ai/ui/resize-handle"
...
import { Session, type Message } from "@corz-ai/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@corz-ai/ui/toast"
...
import { retry } from "@corz-ai/core/util/retry"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://corz.ai/desktop-feedback")}
      renderPanel={() =>
