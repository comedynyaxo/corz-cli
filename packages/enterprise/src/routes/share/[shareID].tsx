import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@corz-ai/sdk/v2"
import { SessionTurn } from "@corz-ai/ui/session-turn"
import { SessionReview } from "@corz-ai/ui/session-review"
import { DataProvider } from "@corz-ai/ui/context"
import { FileComponentProvider } from "@corz-ai/ui/context/file"
import { WorkerPoolProvider } from "@corz-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@corz-ai/ui/logo"
import { IconButton } from "@corz-ai/ui/icon-button"
import { ProviderIcon } from "@corz-ai/ui/provider-icon"
import { iife } from "@corz-ai/core/util/iife"
import { Binary } from "@corz-ai/core/util/binary"
import { NamedError } from "@corz-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@corz-ai/ui/tabs"
import { MessageNav } from "@corz-ai/ui/message-nav"
import { FileSSR } from "@corz-ai/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@corz-ai/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/corz-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | Corz</Title>
              </Show>
              <Meta name="description" content="corz - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/anomalyco/corz"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
