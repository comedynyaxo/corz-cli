...
export const dict = {
  ...
  "dialog.provider.corz.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.corz.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.corzGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Corz tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Corz'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.corzZen.line1":
    "Corz Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.corzZen.visit.prefix": "",
  "provider.connect.corzZen.visit.link": "corz.ai/zen",
  "provider.connect.corzZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Corz'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Corz'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler corz.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Corz sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Corz'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Corz ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (corz.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Corz henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Corz ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Corz Masaüstü",
  ...
  "settings.desktop.wsl.description": "Corz sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Corz'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Corz'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Corz'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Corz'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Corz başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Corz'un en son sürümünü kullanıyorsunuz.",
