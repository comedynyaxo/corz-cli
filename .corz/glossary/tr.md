...
- PR #15835: https://github.com/anomalyco/corz/pull/15835

## Do Not Translate (Locale Additions)

- `Corz` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `corz` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Corz` in prose, `corz` only for exact technical identifiers
...
- Avoid changing `corz` to `Corz` inside commands, URLs, package names, or code literals
