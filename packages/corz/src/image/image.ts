...
export class Service extends Context.Service<Service, Interface>()("@corz/Image") {}
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.promise(async () => {
        try {
          ...
          ;(globalThis as typeof globalThis & { __CORZ_PHOTON_WASM_PATH?: string }).__CORZ_PHOTON_WASM_PATH =
            photonWasm
