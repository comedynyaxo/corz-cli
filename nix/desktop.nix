...
rustPlatform.buildRustPackage (finalAttrs: {
  ...
  preBuild = ''
    ...
    cp ${corz}/bin/corz packages/desktop/src-tauri/sidecars/corz-cli-${stdenv.hostPlatform.rust.rustcTarget}
  '';
  ...
  postFixup = lib.optionalString stdenv.hostPlatform.isLinux ''
    mv $out/bin/Corz $out/bin/corz-desktop
    sed -i 's|^Exec=Corz$|Exec=corz-desktop|' $out/share/applications/Corz.desktop
  '';

  meta = {
    description = "Corz Desktop App";
    homepage = "https://corz.ai";
    license = lib.licenses.mit;
    mainProgram = "corz-desktop";
    inherit (corz.meta) platforms;
  };
})
