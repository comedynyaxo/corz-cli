...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips corz-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-corz-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-corz-directory")).toBeNull()
      expect(result.get("x-corz-workspace")).toBeNull()
