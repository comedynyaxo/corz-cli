...
export function createMenu(deps: Deps) {
  ...
  const template: Electron.MenuItemConstructorOptions[] = [
    ...
    { role: "windowMenu" },
    {
      label: "Help",
      submenu: [
        { label: "Corz Documentation", click: () => shell.openExternal("https://corz.ai/docs") },
        { label: "Support Forum", click: () => shell.openExternal("https://discord.com/invite/corz") },
        { type: "separator" },
        { type: "separator" },
        {
          label: "Share Feedback",
          click: () =>
            shell.openExternal("https://github.com/anomalyco/corz/issues/new?template=feature_request.yml"),
        },
        {
          label: "Report a Bug",
          click: () => shell.openExternal("https://github.com/anomalyco/corz/issues/new?template=bug_report.yml"),
        },
      ],
    },
  ]
