...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  return withRunSpan(
    "RunLifecycle.boot",
    {
      "corz.agent.name": input.agent,
      "corz.directory": input.directory,
      "corz.first": input.first,
      "corz.model.provider": input.model?.providerID,
      "corz.model.id": input.model?.modelID,
      "corz.model.variant": input.variant,
