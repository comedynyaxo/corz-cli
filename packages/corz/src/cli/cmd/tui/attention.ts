...
} from "@corz-ai/plugin/tui"
import stripAnsi from "strip-ansi"
import type { TuiConfig } from "./config/tui"
import { isAttentionSoundName } from "./config/tui-schema"
import * as TuiAudio from "@tui/util/audio"
import defaultSoundPath from "@corz-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@corz-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@corz-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@corz-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@corz-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@corz-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "corz"
const DEFAULT_PACK_ID = "corz.default"
