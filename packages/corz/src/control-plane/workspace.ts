...
export class Service extends Context.Service<Service, Interface>()("@corz/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const startSync = Effect.fn("Workspace.startSync")(function* (space: Info) {
      if (!Flag.CORZ_EXPERIMENTAL_WORKSPACES) return
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        CORZ_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        CORZ_WORKSPACE_ID: config.id,
        CORZ_EXPERIMENTAL_WORKSPACES: "true",
