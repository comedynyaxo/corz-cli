...
import compareVideo from "../../asset/lander/corz-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/corz-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="corz:auth" content={loggedin() ? "true" : "false"} />
