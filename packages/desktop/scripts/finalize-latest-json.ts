...
const releaseId = process.env.CORZ_RELEASE
if (!releaseId) throw new Error("CORZ_RELEASE is required")

const version = process.env.CORZ_VERSION
if (!version) throw new Error("CORZ_VERSION is required")
...
const macxTarGz = "corz-desktop-mac-x64.app.tar.gz"
const macaTarGz = "corz-desktop-mac-arm64.app.tar.gz"
