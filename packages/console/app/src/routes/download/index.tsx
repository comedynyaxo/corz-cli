...
import desktopAppIcon from "../../asset/lander/corz-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://corz.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>corz.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g corz-ai")}>
                <code>
                  npm i -g <strong>corz-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g corz-ai")}>
                <code>
                  bun add -g <strong>corz-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/corz")}>
                <code>
                  brew install <strong>anomalyco/tap/corz</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S corz")}>
                <code>
                  paru -S <strong>corz</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask corz-desktop")}>
                <code>
                  brew install --cask <strong>corz-desktop</strong>
                </code>
                <CopyStatus />
              </button>
