import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@corz-ai/sdk/v2/client"
import { Button } from "@corz-ai/ui/button"
import { useDialog } from "@corz-ai/ui/context/dialog"
import { Dialog } from "@corz-ai/ui/dialog"
import { Icon } from "@corz-ai/ui/icon"
import { IconButton } from "@corz-ai/ui/icon-button"
import { List, type ListRef } from "@corz-ai/ui/list"
import { ProviderIcon } from "@corz-ai/ui/provider-icon"
import { Spinner } from "@corz-ai/ui/spinner"
  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <Switch>
          <Match when={provider().id === "corz"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.corzZen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.corzZen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.corzZen.visit.prefix")}
                <Link href="https://corz.ai/zen" tabIndex={-1}>
                  {language.t("provider.connect.corzZen.visit.link")}
                </Link>
                {language.t("provider.connect.corzZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>
