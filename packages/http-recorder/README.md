...
Internal package; depended on as `@corz-ai/http-recorder` from another
workspace package.

```ts
import { HttpRecorder } from "@corz-ai/http-recorder"
```
...
```ts
import { HttpRecorder, Redactor } from "@corz-ai/http-recorder"
