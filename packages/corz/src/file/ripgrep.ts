...
import { sanitizedProcessEnv } from "@corz-ai/core/util/corz-process"
...
export class Service extends Context.Service<Service, Interface>()("@corz/Ripgrep") {}
    ...
    Effect.gen(function* () {
      ...
      const tree: Interface["tree"] = Effect.fn("Ripgrep.tree")(function* (input: TreeInput) {
        ...
        for (const file of list) {
          if (file.includes(".corz")) continue
