...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/corz.git")).toEqual({ owner: "sst", repo: "corz" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/corz")).toEqual({ owner: "sst", repo: "corz" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/corz.git")).toEqual({ owner: "sst", repo: "corz" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/corz")).toEqual({ owner: "sst", repo: "corz" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/corz.git")).toEqual({ owner: "sst", repo: "corz" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/corz")).toEqual({ owner: "sst", repo: "corz" })
})
