...
Practical reference for the current tool-migration state in `packages/corz`.
...
Tool tests should use the existing Effect helpers in `packages/corz/test/lib/effect.ts`:
