...
beforeAll(async () => {
  ...
  mock.module("@corz-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@corz-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@corz-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@corz-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
