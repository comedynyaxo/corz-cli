...
Use this folder for locale-specific translation guidance that supplements `.corz/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/corz/pull/12345

## Do Not Translate (Locale Additions)

- `Corz` (preserve casing)
