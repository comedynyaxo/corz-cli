...
import type { AssistantMessage, FilePart, UserMessage } from "@corz-ai/sdk/v2"
...
import { useBindings, useCommandShortcut, useLeaderActive, useCorzKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.CORZ_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
