import type { TuiDialogSelectOption, TuiPluginApi, TuiRouteDefinition, TuiSlotProps } from "@corz-ai/plugin/tui"
...
import type { useCorzKeymap } from "../keymap"
...
type Input = {
  ...
  keymap: ReturnType<typeof useCorzKeymap>
