...
import type { CorzClient, PermissionRequest, QuestionRequest, ToolPart } from "@corz-ai/sdk/v2"
...
type PromptModel = Parameters<CorzClient["session"]["prompt"]>[0]["model"]
type PromptInput = Parameters<CorzClient["session"]["prompt"]>[0]

export type RunPromptPart = NonNullable<PromptInput["parts"]>[number]

export type RunCommand = NonNullable<Awaited<ReturnType<CorzClient["command"]["list"]>>["data"]>[number]

export type RunProvider = NonNullable<Awaited<ReturnType<CorzClient["provider"]["list"]>>["data"]>["all"][number]
...
export type RunAgent = NonNullable<Awaited<ReturnType<CorzClient["app"]["agents"]>>["data"]>[number]

type RunResourceMap = NonNullable<Awaited<ReturnType<CorzClient["experimental"]["resource"]["list"]>>["data"]>
...
export type PermissionReply = Parameters<CorzClient["permission"]["reply"]>[0]

export type QuestionReply = Parameters<CorzClient["question"]["reply"]>[0]

export type QuestionReject = Parameters<CorzClient["question"]["reject"]>[0]
