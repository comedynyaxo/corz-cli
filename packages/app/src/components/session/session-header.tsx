import { AppIcon } from "@corz-ai/ui/app-icon"
...
import { Keybind } from "@corz-ai/ui/keybind"
...
export function SessionHeader() {
  ...
  const isDesktopBeta = platform.platform === "desktop" && import.meta.env.VITE_CORZ_CHANNEL === "beta"
  ...
  onMount(() => {
    setCenterMount(document.getElementById("corz-titlebar-center"))
    setRightMount(document.getElementById("corz-titlebar-right"))
  })
