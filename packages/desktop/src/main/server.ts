...
const SIDECAR_SERVICE_NAME = "corz server"
...
export function preferAppEnv(userDataPath: string) {
  ...
  Object.assign(process.env, {
    ...
    CORZ_EXPERIMENTAL_ICON_DISCOVERY: "true",
    CORZ_EXPERIMENTAL_FILEWATCHER: "true",
    CORZ_CLIENT: "desktop",
...
export async function checkHealth(url: string, password?: string | null): Promise<boolean> {
  ...
  if (password) {
    const auth = Buffer.from(`corz:${password}`).toString("base64")
