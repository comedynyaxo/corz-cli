export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji Corz",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} Corz. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.cli.installed.message":
    "CLI zainstalowane w {{path}}\n\nUruchom ponownie terminal, aby użyć polecenia 'corz'.",
