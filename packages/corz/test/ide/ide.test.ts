...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders CORZ_CALLER", () => {
    process.env["CORZ_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode CORZ_CALLER", () => {
    process.env["CORZ_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown CORZ_CALLER", () => {
    process.env["CORZ_CALLER"] = "unknown"
