...
>()("@corz/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@corz/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceID | undefined {
  return Flag.CORZ_WORKSPACE_ID ? WorkspaceID.make(Flag.CORZ_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-corz-directory"] || process.cwd()
}
