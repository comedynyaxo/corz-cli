...
- PR #13942: https://github.com/anomalyco/corz/pull/13942

## Do Not Translate (Locale Additions)

- `Corz` (preserve casing in prose; keep `corz` only when it is part of commands, package names, paths, or code)
- `Corz Zen`
- `Corz CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `corz` in prose when referring to the product name; use `Corz`
