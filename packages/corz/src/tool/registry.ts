...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@corz-ai/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@corz/ToolRegistry") {}
