...
- PR #10809: https://github.com/anomalyco/corz/pull/10809
- PR #11496: https://github.com/anomalyco/corz/pull/11496

## Do Not Translate (Locale Additions)

- `Corz` (preserve casing in prose; keep `corz` only in commands, package names, paths, or code)
- `Corz CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
