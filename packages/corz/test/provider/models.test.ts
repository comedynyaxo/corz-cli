...
// test/preload.ts pins CORZ_MODELS_PATH to a fixture so other tests can
...
// bun process.
const ORIGINAL_MODELS_PATH = Flag.CORZ_MODELS_PATH
const ORIGINAL_DISABLE_FETCH = Flag.CORZ_DISABLE_MODELS_FETCH
beforeAll(() => {
  Flag.CORZ_MODELS_PATH = undefined
  Flag.CORZ_DISABLE_MODELS_FETCH = true
})
afterAll(() => {
  Flag.CORZ_MODELS_PATH = ORIGINAL_MODELS_PATH
  Flag.CORZ_DISABLE_MODELS_FETCH = ORIGINAL_DISABLE_FETCH
})
