...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips corz-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-corz-directory"]).toBeUndefined()
      expect(forwarded["x-corz-workspace"]).toBeUndefined()
