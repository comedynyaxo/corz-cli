import type * as SDK from "@corz-ai/sdk/v2"
...
const disabled = process.env["CORZ_DISABLE_SHARE"] === "true" || process.env["CORZ_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@corz/ShareNext") {}
