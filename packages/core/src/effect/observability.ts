...
import { ensureProcessMetadata } from "../util/corz-process"
...
export function resource(): { serviceName: string; serviceVersion: string; attributes: Record<string, string> } {
  ...
  return {
    ...
    attributes: {
      ...
      "corz.client": Flag.CORZ_CLIENT,
      "corz.process_role": processMetadata.processRole,
      "corz.run_id": processMetadata.runID,
