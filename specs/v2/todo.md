...
The corz server has moved to the Effect HttpApi backend. Remaining work is
...
- plugins get global "corz" instance like in that post i showed
- corz instance has stuff like `corz.session.prompt()` or
  `corz.tool.register({...})`
