 ...
 *   "@corz/ServerAuthConfig",
 *   {
 *     password: Config.string("CORZ_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("CORZ_SERVER_USERNAME").pipe(Config.withDefault("corz")),
 *   },
 * ) {}
 *
