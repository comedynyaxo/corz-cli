...
const FILES = [
  "AGENTS.md",
  ...(Flag.CORZ_DISABLE_CLAUDE_CODE_PROMPT ? [] : ["CLAUDE.md"]),
...
export class Service extends Context.Service<Service, Interface>()("@corz/Instruction") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const globalFiles = [
      ...
      ...(!Flag.CORZ_DISABLE_CLAUDE_CODE_PROMPT ? [path.join(global.home, ".claude", "CLAUDE.md")] : []),
    ]
