...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/corz/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/corz...\n")
...
console.log("Fetching npm all-time downloads for corz-ai...\n")
const npmDownloads = await fetchNpmDownloads("corz-ai")
