...
import { IconCorz } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "corz/session/message-v2"
import type { Message } from "corz/session/message"
import type { Session } from "corz/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.corz_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.corz_name}>
                    <IconCorz width={16} height={16} />
                  </div>
